    ...
    <div class="p-6 flex-grow flex flex-col">
        <h3 class="text-xl font-bold mb-4 text-slate-800">
            <a href="<?php echo esc_url($link); ?>" target="<?php echo esc_attr($target); ?>"
                ...
                <span class="mt-3 w-12 h-1 bg-blue-600 transition-all duration-300 group-hover:w-full"></span>
            </a>
        </h3>
        ...
        <?php if ($link): ?>
            <div class="mt-auto px-6 pb-6">
                <a href="<?php echo esc_url($link); ?>" target="<?php echo esc_attr($target); ?>"
                    class="group flex w-full items-center justify-center rounded-lg bg-blue-600 px-6 py-3 font-semibold text-white shadow-md transition-all duration-300 hover:-translate-y-1 hover:bg-blue-700 hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2">
                    <span>Saber más</span>
